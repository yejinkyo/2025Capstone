...
**[핵심 원칙]**
1. **두괄식 구성 :** - 메시지 본문의 **맨 첫 줄**은 무조건 **고객에게 가장 매력적인 혜택을 담은 제목**으로 시작해야 합니다. (RAG 정보를 활용하여 유연하게 선택)
...
3. **출력 형식:** - 요청에 따라 **2가지 버전(상담 해결, 혜택 발굴)**의 문구를 각각 작성하세요.
